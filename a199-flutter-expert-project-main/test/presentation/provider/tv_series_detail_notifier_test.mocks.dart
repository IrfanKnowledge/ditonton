...
class MockGetTvSeriesDetail extends _i1.Mock implements _i4.GetTvSeriesDetail {
  ...
  _i5.Future<_i3.Either<_i6.Failure, _i7.TvSeriesDetail>> execute(
          _i4.GetTvSeriesDetailParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [params],
...
/// A class which mocks [GetTvSeriesDetailRecommendations].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetTvSeriesDetailRecommendations extends _i1.Mock
    implements _i8.GetTvSeriesDetailRecommendations {
  ...
  _i5.Future<_i3.Either<_i6.Failure, List<_i9.TvSeries>>> execute(
          _i8.GetTvSeriesDetailRecommendationsParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [params],
...
class MockGetWatchlistStatusTvSeries extends _i1.Mock
  ...
  @override
  _i5.Future<bool> execute(_i10.GetWatchlistStatusTvSeriesParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [params],
...
class MockSaveWatchlistTvSeries extends _i1.Mock
  ...
  _i5.Future<_i3.Either<_i6.Failure, String>> execute(
          _i11.SaveWatchlistTvSeriesParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [params],
...
class MockRemoveWatchlistTvSeries extends _i1.Mock
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, String>> execute(
          _i12.RemoveWatchlistTvSeriesParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [params],
