...
import 'movies_list_now_playing_bloc_test.mocks.dart';

///
/// Bloc [MoviesListNowPlayingBloc],
/// bergantung pada usecase [GetNowPlayingMovies]
///
@GenerateMocks([GetNowPlayingMovies])
void main() {
  late MoviesListNowPlayingBloc bloc;
  ...
  setUp(
    () {
      ...
      bloc = MoviesListNowPlayingBloc(
        getNowPlayingMovies: mockUseCase,
      );
    },
  );
  ...
  blocTest<MoviesListNowPlayingBloc, RequestStateFr<List<Movie>>>(
    ...
    build: () {
      ...
      return MoviesListNowPlayingBloc(
        getNowPlayingMovies: mockUseCase,
      );
    },
    act: (bloc) {
      return bloc.add(const MoviesListNowPlayingEvent.started());
    },
