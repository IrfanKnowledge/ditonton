...
import 'movies_list_top_rated_bloc_test.mocks.dart';
...
void main() {
  late MoviesListTopRatedBloc bloc;
  ...
  blocTest<MoviesListTopRatedBloc, RequestStateFr<List<Movie>>>(
    ...
    build: () {
      ...
      return MoviesListTopRatedBloc(
        getTopRatedMovies: mockUseCase,
      );
    },
    act: (bloc) {
      return bloc.add(const MoviesListTopRatedEvent.started());
    },
